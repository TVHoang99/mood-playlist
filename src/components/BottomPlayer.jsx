		...
		<div className="fixed bottom-0 left-0 right-0 z-50 bg-gradient-to-t from-slate-950 via-slate-950/98 to-transparent">
			<div className="max-w-4xl mx-auto px-4 pt-4 pb-2">
				<div className="relative">
					...
					{showControls && (
						<div className="absolute right-20 top-1/2 -translate-y-1/2 flex items-center gap-1 bg-black/40 rounded-full px-1 py-0.5">
							<button
								onClick={goToPrevTrack}
								className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-white/20 transition-colors cursor-pointer text-white"
							>
