...
const SCOPES = ['streaming', 'user-read-playback-state', 'user-modify-playback-state', 'user-library-read', 'user-read-private', 'playlist-modify-private'].join(' ')
...
export function isLoggedIn() {
	...
	return token && expiry && Date.now() < parseInt(expiry) - 30000
}
